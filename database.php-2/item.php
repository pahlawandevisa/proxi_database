...
class Item{
	...
	function postItem($data){
		...
		$sql = "insert into proximar_proxi.Item (item_title, item_description,item_img_url, item_current_price, 
				item_post_date,item_owner_id) values( ?,?,?,?,Now(),?)
				";
		
		$data_array = array($item_title, $item_description,$image, 
				$item_low_price, $owner_id
			);
